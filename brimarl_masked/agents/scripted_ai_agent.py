...
class ScriptedAIAgent(brisc.Agent):
    """Agent playing using predefined heuristics."""

    def __init__(self):
        super().__init__("ScriptedAIAgent")
        self.name = 'ScriptedAIAgent'

    def state(self, game: brisc.BriscolaGame, player: brisc.BriscolaPlayer, current_player: brisc.BriscolaPlayer):
    ...
    def action(self, game: brisc.BriscolaGame, player: brisc.BriscolaPlayer):
        ...
        if points_on_table:
            ...
            if win_actions:
                ...
                if len(win_actions) == 1:
                    ...
                    return win_actions[weakest_win_index], None, None
        ...
        if weakest_card.points > 4:
            ...
            return self.hand.index(low_points_sorted_cards[0]), None, None
        else:
            return weakest_index, None, None
